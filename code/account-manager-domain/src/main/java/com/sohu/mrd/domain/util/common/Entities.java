...
public class Entities {
     ...
     * 基本实体定义。
     */
    private static final String[][] COOKIE_SET = {
            {"#61", "61"},
            {"#44", "44"}
    };
     ...
     * 组合cookie
     */
    public static final Entities COMBINED_COOKIE;
    ...
    static {
        ...
        COMBINED_COOKIE = new Entities();
        COMBINED_COOKIE.addEntities(COOKIE_SET);
    }
    ...
    private Map entityValueToName = new HashMap();
