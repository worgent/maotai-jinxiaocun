 ...
 * Date: 2010-5-5<br>
 * Time: 10:13:18<br>
 * 修改日期：2010-7-2 修改人：杨思勇
 */
public class JdUrl implements Cloneable {
	private final static Log log = LogFactory.getLog(JdUrl.class);
	/**
	 * 认证的用户名
	 */
	 ...
	 * addQueryData(key,List)，这种情况下，key是同一个，value会生成多个、在vm中可以这样：.addQueryData(
	...
	/**
	 * 渲染url。不会复位url的值。 支持List Map 数据和普通对象
	 *
	 * @return
	 */
