...
public class StringUtils extends org.apache.commons.lang.StringUtils {
     ...
     * Method change ...
     * <p/>
     * 去除文本中的外链，js脚本，<object>,<frame><iframe>
     *
...
//       String regEx_href_content = "(href=[\\\"\\'](http:\\/\\/|\\.\\/|\\/)?[\\s\\S]*?[\\\"\\'])";
        ...
        while (m_a.find()) {
            ...
            if (!m_href.find()) {
                ...
                while (m_content.find()) {      //只替换href的内容
                    String change = null;
...
//       Matcher m_img=p_img.matcher(temp);                             // 过滤图片
...
//       }
    ...
    public static void main(String args[]) {
        String testStr = "<div class=\"mc\">\n" +
                ...
                "</li>\n" +
                "<li>\n" +
                "<img height=\"100\" width=\"100\" alt=\"飞利浦（PHILIPS）X630 GSM手机(炫酷黑)\" src=\"http://img10.360buyimg.com/n4/3646/f1168036-8be9-4da7-9ba0-1815d987d316.jpg\">" +
                "<div class=\"p-img\"><a href=\"http://www.360buy.com/product/213235.html\" target=\"_blank\"><img height=\"100\" width=\"100\" alt=\"摩托罗拉（MOTOROLA）ME501(黑色)  GSM/WCDMA 非定制手机\" src=\"http://img10.360buyimg.com/n4/4128/1bf6efee-d85c-4d9a-b457-41c964796687.jpg\"></a></div>\n" +
