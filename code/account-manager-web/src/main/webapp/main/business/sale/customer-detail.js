    ...
    gebo_galery_table = {
        init: function() {
        	dataTableIndex = $('#dt_gal').dataTable({
...
//        			$.ajax({
//                	    type: 'get',
//                	    url: window.location.origin + "/order/ajax/delete.html",
//                	    dataType: "text",
//                	    data: {
//                	    	"id": id,
//                	    },
...
//        }
        bindExcel: function(){
        	$("#excel").click(function(){
        		ExcelForm.serialNumber.value = $("#serialNumber").val();
        		ExcelForm.submit();
        	})
        }
    };
